"""
Custom exceptions describe specific error conditions clearly.
Custom exceptions separate different failure types, and handle them in a targeted way.
...
This helps me catch unexpected issues without hiding bugs. 
Later, I refine the exception handling once I understand the failure modes better
"""
